...
public class Add_New_Result extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        String phy=jTextField4.getText();
        String mech=jTextField5.getText();
        String java=jTextField6.getText();
        String ele=jTextField7.getText();
        String ce=jTextField8.getText();
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/SRM","root","Minimum@1998");
        
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("SELECT * FROM STUDENT WHERE REG_NO='"+regno+"'");
            if(rs.next()){
                st.executeUpdate("INSERT INTO RESULT (REG_NO,MATHS,ENGLISH,PHYSICS,MECHANICS,JAVA,ELECTRONICS,CIVIL)VALUES('"+regno+"','"+math+"','"+eng+"','"+phy+"','"+mech+"','"+java+"','"+ele+"','"+ce+"')");
